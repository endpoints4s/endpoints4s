...
trait LowLevelEndpoints
    extends algebra.LowLevelEndpoints
  ...
  lazy val rawRequestEntity: RequestEntity[RawRequestEntity] = (entity, xhr) =>
    entity(xhr)
  ...
  lazy val rawResponseEntity: Response[RawResponseEntity] = xhr =>
    Some(_ => Right(xhr))
