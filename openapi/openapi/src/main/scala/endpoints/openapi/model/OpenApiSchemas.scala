...
trait OpenApiSchemas extends JsonSchemas {
  ...
  implicit lazy val schemaSchema: JsonSchema[Schema] = (
    ...
    case ((((((((((Some("integer"), format), _), _), _), _), _), _), _), _), description) => Schema.Primitive("integer", format, description)
    case ((((((((((Some("string"), format), _), _), _), _), _), _), _), _), description)  => Schema.Primitive("string", format, description)
    case ((((((((((Some("object"), _), _), Some(props)), required), _), _), _), _), _), description) =>
      ...
      Schema.Object(properties, description)
    ...
    ((((((((((fields.`type`, fields.format), fields.items), fields.properties), fields.required.map(_.toList)), fields.oneOf), fields.discriminator), fields.allOf), fields.enum), fields.ref), fields.description)
  }
  ...
  private def schemaToFields(schema: Schema): SchemaFields = schema match {
    ...
    case Schema.Object(props, descr) =>
      ...
      SchemaFields(`type` = Some("object"), properties = Some(propsMap), required = if (required.isEmpty) None else Some(required), description = descr)
