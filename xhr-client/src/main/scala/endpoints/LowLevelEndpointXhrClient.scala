...
/**
  * Interpreter for [[LowLevelEndpointAlg]] that represents the response as a
  * [[XMLHttpRequest]] value.
  */
trait LowLevelEndpointXhrClient extends LowLevelEndpointAlg with EndpointXhrClient {
