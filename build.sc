...
object openapi extends Module {
  ...
  object `json-schema` extends mill.Cross[JsonSchemaModule](`scala 2.10 to 2.12`:_*)
  ...
  class OpenApiModule(val crossVersion: String) extends EndpointsModule {
    ...
    override def moduleDeps = Seq(`json-schema`(crossVersion), algebras.algebra(crossVersion))
